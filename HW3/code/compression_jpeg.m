...
for r=1:64
    for c=1:64
        DCT_B((r-1)*64+c, 1:8, 1:8) = dct2(reshape(B((r-1)*64+c,:,:),8,8)); 
    end
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for r=1:64
    for c=1:64
        DB((r-1)*64+c, 1:8, 1:8) = idct2(reshape(DCT_C((r-1)*64+c,:,:),8,8)); 
    end
end
